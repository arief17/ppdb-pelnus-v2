        ...
        <section class="content">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-link active" id="nav-contact-tab" data-toggle="tab" href="<?php echo base_url() ?>siswa/kelola_data/data_prestasi" role="tab" aria-controls="nav-contact" aria-selected="false">Data Prestasi</a>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6>Data Prestasi</h6>
                            <form action="<?php echo base_url('siswa/kelola_data/data_prestasi/tambah') ?>" method="post" class="mt-3">
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Jenis Prestasi</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Jenis Prestasi" name="jenis_prestasi">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Tingkat Prestasi</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Tingkat Prestaasi" name="tingkat">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Nama Prestasi</label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Penyelenggara" name="penyelenggara">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-5">
